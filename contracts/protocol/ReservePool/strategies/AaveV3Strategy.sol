 ...
 */
contract AaveV3Strategy is Initializable, ReentrancyGuardUpgradeable, IGReserveStrategy {
    ...
    modifier onlyReservePool(){
        require(msg.sender == reservePoolAddress,"CALLER_NOT_RESERVE_POOL");
        _;
    }
     ...
     */
    function deposit(uint256 amount) external virtual onlyReservePool nonReentrant {
     ...
     */
    function withdraw(uint256 amount) external virtual onlyReservePool nonReentrant {
