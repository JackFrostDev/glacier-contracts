...
describe("glAVAX", function () {
  ...
  describe("Deployment", function () {
    it("Token stats set correctly", async function () {
    ...
    it("Address book is set correctly", async function () {
        ...
        expect(await addressBookFromContract.oracleAddress()).to.equal(await addressBook.oracleAddress())
